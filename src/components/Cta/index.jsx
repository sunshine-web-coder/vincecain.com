                ...
                <div className="col-12">
                    <div className="cta-section-box position-relative py-3">
                        ...
                        <div className="cta-content p-4 p-md-5 p-lg-6">
                            <h2 className='ff-tertiary fs-4xl fs-sm-5xl fs-md-6xl mb-3'>join our growing <div className='ff-secondary'>community</div></h2>
                            <a href="https://t.me/vincechain"><button type='button' className="btn btn-primary">Join Us</button></a>
                        </div>
                    </div>
                </div>
            </div>
