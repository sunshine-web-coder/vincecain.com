                ...
                <div className="col-12">
                    <div className="cta-section-box position-relative py-3">
                        ...
                        <div className="cta-content p-4 p-md-5 p-lg-6">
                            <h2 className='ff-tertiary fs-4xl fs-sm-5xl fs-md-6xl mb-3'>There Is a <div className='ff-secondary'>community</div> for you</h2>
                            <p>Vince Chain has a growing community of resources, contributors, users, developers, and more. Get all the support you may need in our community.</p>
