...
// import SHAPE_1 from './shape-2.png';
import SHAPE_1 from './Monitor-amico.svg';
            ...
            <div className="row gy-5 align-items-center">
                <div className="col-12">
                    <div className="cta-section-box position-relative py-3">
                        ...
                        {/* SHAPE 1 */}
                        <img src={SHAPE_1} alt="" className="shape-1 cta-img" />
                        {/* SHAPE 2*/}
                        ...
                        <motion.svg className='shape-2' width="173" height="172" viewBox="0 0 173 172" fill="none" xmlns="http://www.w3.org/2000/svg">
                         ...
                         <div className="cta-content p-4 p-md-5 p-lg-6">
                            <h2 className='ff-tertiary fs-4xl fs-sm-5xl fs-md-6xl mb-3'>Introducing the <div className='ff-secondary'>Vince Chain Coin <span className="arial">(VCE)</span></div></h2>
                            <p>$VCE is the native coin of the Vince Chain Blockchain and the utility coin of the Vince Chain Ecosystem. Functions include validating transactions, staking, and governance.</p>
                            <p>What’s more? Vince Chain Coin (VCE) is interoperable with Ethereum Virtual Machine and other chains. Rewards pools and incentives on Vince Chain will be managed by $VCE.</p>
                            <strong>Want to join Vince Chain?</strong>
                            <div className="sButton">
                                <a target="_blank" href="">Buy VCE Now</a>
                            </div>
                        </div>
